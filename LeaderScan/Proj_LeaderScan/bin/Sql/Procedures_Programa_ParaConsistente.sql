...
CREATE PROCEDURE `PROC_INSERT_T03`(
    IN v03_nome_perfil VARCHAR(255),
    IN v03_pms_criar_prop tinyint(1),
    IN v03_pms_responder_prop tinyint(1),
    IN v03_peso_perfil INT
)
BEGIN
    INSERT INTO T03_Perfil (A03_nome_perfil, A03_pms_criar_prop, A03_pms_responder_prop, A03_peso_perfil)
    VALUES ( v03_nome_perfil,  v03_pms_criar_prop,  v03_pms_responder_prop,  v03_peso_perfil);
END //
...
BEGIN
    UPDATE T03_Perfil
    SET A03_nome_perfil = v03_nome_perfil, A03_pms_criar_prop = v03_pms_criar_prop,
        A03_pms_responder_prop = v03_pms_responder_prop, A03_peso_perfil = v03_peso_perfil
