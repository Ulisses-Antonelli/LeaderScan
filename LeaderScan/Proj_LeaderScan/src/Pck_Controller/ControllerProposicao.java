...
public class ControllerProposicao {
    ...
    public void inserirProposicao(String titulo, String descricao, int limite_decisao, java.sql.Timestamp data_criacao)
            throws SQLException {
    ...
    public void inserirProposicao(String titulo, String descricao, java.sql.Timestamp data_criacao)
            throws SQLException {
        ModelProposicao proposicao = new ModelProposicao();
        proposicao.setV04_titulo(titulo);
        proposicao.setV04_descricao(descricao);
    ...
    public void atualizarProposicao(String titulo, String descricao, int limite_decisao, java.sql.Timestamp data_criacao)
            throws SQLException {
        ModelProposicao proposicao = new ModelProposicao();
        proposicao.setV04_titulo(titulo);
        proposicao.setV04_descricao(descricao);
