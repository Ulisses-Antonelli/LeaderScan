...
public class ControllerParticipante {
    ...
    public void inserirParticipante(String grupo, int codigoUsuario, int codigoPerfil, int codigoProposicao) throws SQLException {
    ...
    public void atualizarParticipante(String grupo, int codigoUsuario, int codigoPerfil, int codigoProposicao) throws SQLException {
        ModelParticipante participante = new ModelParticipante();
        participante.setV05_grupo(grupo);
        participante.setV05_codigo_T02_Usuario(codigoUsuario);
        participante.setV05_codigo_T03_Perfil(codigoPerfil);
